...
HD_PWD='E:/pgprogram/tcd_pgprogram/5m01IntegratedSystemDesign/lab04_VVD/lab04_VVD.runs/base_smartconnect_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_smartconnect_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_smartconnect_1_1.tcl
