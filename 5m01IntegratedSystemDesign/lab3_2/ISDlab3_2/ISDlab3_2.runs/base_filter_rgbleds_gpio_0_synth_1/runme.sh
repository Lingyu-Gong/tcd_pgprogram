...
HD_PWD='C:/PYNQ-image_v2.5.4/boards/Pynq-Z2/base/base_filter/base_filter.runs/base_filter_rgbleds_gpio_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_filter_rgbleds_gpio_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_filter_rgbleds_gpio_0.tcl
