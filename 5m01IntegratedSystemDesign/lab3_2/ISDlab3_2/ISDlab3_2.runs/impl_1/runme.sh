...
HD_PWD='E:/pgprogram/tcd-PG-cm/5m01IntegratedSystemDesign/lab3_2/ISDlab3_2/ISDlab3_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log base_filter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source base_filter_wrapper.tcl -notrace
