...
set C_modelArgList {
	{ src_rows_V_out int 11 regular {fifo 1}  }
	{ src_cols_V_out int 12 regular {fifo 1}  }
	{ sobel_g_rows_V_out int 11 regular {fifo 1}  }
	{ sobel_g_cols_V_out int 12 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "src_rows_V_out", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
 	{ "Name" : "src_cols_V_out", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sobel_g_rows_V_out", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ src_rows_V_out_din sc_out sc_lv 11 signal 0 } 
	...
	{ sobel_g_rows_V_out_din sc_out sc_lv 11 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "src_rows_V_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "src_rows_V_out", "role": "din" }} , 
 	...
 	{ "name": "sobel_g_rows_V_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "sobel_g_rows_V_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	src_rows_V_out { ap_fifo {  { src_rows_V_out_din fifo_data 1 11 }  { src_rows_V_out_full_n fifo_status 0 1 }  { src_rows_V_out_write fifo_update 1 1 } } }
	...
	sobel_g_rows_V_out { ap_fifo {  { sobel_g_rows_V_out_din fifo_data 1 11 }  { sobel_g_rows_V_out_full_n fifo_status 0 1 }  { sobel_g_rows_V_out_write fifo_update 1 1 } } }
