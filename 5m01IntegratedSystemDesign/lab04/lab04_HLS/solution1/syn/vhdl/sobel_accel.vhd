...
architecture behav of sobel_accel is 
    ...
    "sobel_accel,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.575500,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=43,HLS_SYN_FF=7791,HLS_SYN_LUT=15612,HLS_VERSION=2019_2}";
    ...
    signal Block_proc_U0_src_rows_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal Block_proc_U0_sobel_g_rows_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal src_rows_V_c_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal sobel_g_rows_V_c_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal src_rows_V_c26_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal sobel_g_rows_V_c28_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    port (
        ...
        src_rows_V_out_din : OUT STD_LOGIC_VECTOR (10 downto 0);
        ...
        sobel_g_rows_V_out_din : OUT STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    src_rows_V_c_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    sobel_g_rows_V_c_U : component fifo_w11_d8_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_rows_V_c26_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    sobel_g_rows_V_c28_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
