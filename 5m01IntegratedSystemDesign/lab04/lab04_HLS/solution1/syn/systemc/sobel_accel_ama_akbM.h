...
// ==============================================================
#ifndef __sobel_accel_ama_akbM__HH__
#define __sobel_accel_ama_akbM__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_ama_akbM) {
    ...
    SC_CTOR(sobel_accel_ama_akbM):  simcore_ama_0_U ("simcore_ama_0_U") {
