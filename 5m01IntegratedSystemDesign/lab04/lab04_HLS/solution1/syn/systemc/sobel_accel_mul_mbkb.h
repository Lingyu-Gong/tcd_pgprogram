...
// ==============================================================
#ifndef __sobel_accel_mul_mbkb__HH__
#define __sobel_accel_mul_mbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mul_mbkb) {
    ...
    SC_CTOR(sobel_accel_mul_mbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
