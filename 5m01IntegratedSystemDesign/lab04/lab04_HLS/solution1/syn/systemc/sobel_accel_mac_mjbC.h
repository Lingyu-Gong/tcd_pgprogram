...
// ==============================================================
#ifndef __sobel_accel_mac_mjbC__HH__
#define __sobel_accel_mac_mjbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mac_mjbC) {
    ...
    SC_CTOR(sobel_accel_mac_mjbC):  simcore_mac_2_U ("simcore_mac_2_U") {
