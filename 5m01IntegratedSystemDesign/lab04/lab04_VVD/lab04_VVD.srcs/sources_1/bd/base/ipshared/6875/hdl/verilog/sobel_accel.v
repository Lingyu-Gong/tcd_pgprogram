...
wire   [10:0] sobel_g_rows_V_c_dout;
...
wire   [10:0] sobel_g_rows_V_c28_dout;
...
fifo_w11_d8_A sobel_g_rows_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w11_d2_A src_rows_V_c26_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w11_d2_A sobel_g_rows_V_c28_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
