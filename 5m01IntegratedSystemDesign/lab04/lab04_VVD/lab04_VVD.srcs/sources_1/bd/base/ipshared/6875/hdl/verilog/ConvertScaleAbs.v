...
wire   [51:0] tmp_V_4_fu_223_p1;
reg   [51:0] tmp_V_4_reg_812;
...
wire  signed [11:0] F2_4_fu_261_p3;
reg  signed [11:0] F2_4_reg_844;
reg  signed [11:0] F2_4_reg_844_pp0_iter9_reg;
...
wire   [0:0] p_Result_13_fu_371_p3;
reg   [0:0] p_Result_13_reg_880;
wire   [7:0] p_Val2_19_fu_383_p2;
reg   [7:0] p_Val2_19_reg_885;
...
wire   [0:0] and_ln603_4_fu_440_p2;
reg   [0:0] and_ln603_4_reg_906;
reg   [0:0] and_ln603_4_reg_906_pp0_iter10_reg;
wire   [0:0] icmp_ln621_fu_464_p2;
reg   [0:0] icmp_ln621_reg_911;
reg   [0:0] icmp_ln621_reg_911_pp0_iter10_reg;
wire   [0:0] xor_ln621_2_fu_478_p2;
reg   [0:0] xor_ln621_2_reg_916;
wire   [0:0] Range1_all_ones_2_fu_504_p2;
reg   [0:0] Range1_all_ones_2_reg_923;
reg   [0:0] tmp_60_reg_930;
wire   [0:0] icmp_ln631_fu_518_p2;
reg   [0:0] icmp_ln631_reg_935;
wire   [53:0] zext_ln635_fu_524_p1;
reg   [53:0] zext_ln635_reg_941;
wire   [53:0] Range2_V_2_fu_528_p2;
reg   [53:0] Range2_V_2_reg_946;
wire   [0:0] Range1_all_zeros_2_fu_540_p2;
reg   [0:0] Range1_all_zeros_2_reg_952;
wire   [0:0] and_ln642_fu_558_p2;
reg   [0:0] and_ln642_reg_957;
wire   [7:0] p_Val2_20_fu_611_p3;
reg   [7:0] p_Val2_20_reg_963;
wire   [0:0] select_ln639_fu_681_p3;
reg   [0:0] select_ln639_reg_969;
wire   [0:0] select_ln639_2_fu_696_p3;
reg   [0:0] select_ln639_2_reg_974;
...
wire   [0:0] xor_ln639_2_fu_546_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln2527_reg_788_pp0_iter8_reg == 1'd0))) begin
        ...
        p_Result_13_reg_880 <= p_Val2_18_fu_334_p3[32'd7];
        p_Val2_19_reg_885 <= p_Val2_19_fu_383_p2;
        tmp_60_reg_930 <= pos2_fu_455_p2[32'd11];
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'd0 == and_ln603_4_reg_906) & (icmp_ln2527_reg_788_pp0_iter9_reg == 1'd0))) begin
        select_ln639_2_reg_974 <= select_ln639_2_fu_696_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln2527_reg_788_pp0_iter9_reg == 1'd0) & (1'd1 == and_ln603_4_reg_906))) begin
...
assign F2_4_fu_261_p3 = ((icmp_ln581_fu_249_p2[0:0] === 1'b1) ? F2_fu_243_p2 : sub_ln581_fu_255_p2);

assign F2_fu_243_p2 = (12'd1075 - zext_ln461_fu_233_p1);

assign Range1_all_ones_2_fu_504_p2 = (icmp_ln621_fu_464_p2 & and_ln621_fu_498_p2);

assign Range1_all_ones_fu_651_p2 = (select_ln631_fu_639_p3 & Range1_all_ones_2_reg_923);

assign Range1_all_zeros_2_fu_540_p2 = ((p_Result_12_fu_313_p1 == 54'd0) ? 1'b1 : 1'b0);

assign Range1_all_zeros_fu_661_p2 = (1'd1 ^ Range1_all_ones_2_reg_923);

assign Range2_V_2_fu_528_p2 = p_Result_12_fu_313_p1 >> zext_ln635_fu_524_p1;

assign Range2_all_ones_fu_634_p2 = ((Range2_V_2_reg_946 == r_V_fu_629_p2) ? 1'b1 : 1'b0);

assign add_ln591_fu_346_p2 = ($signed(12'd4095) + $signed(F2_reg_830));

assign and_ln403_2_fu_589_p2 = (xor_ln403_fu_584_p2 & and_ln581_reg_891);

assign and_ln403_fu_413_p2 = (p_Result_13_fu_371_p3 & and_ln581_fu_408_p2);

assign and_ln428_2_fu_731_p2 = (icmp_ln837_reg_874_pp0_iter10_reg & icmp_ln833_reg_818_pp0_iter10_reg);
...
assign and_ln603_3_fu_434_p2 = (xor_ln416_fu_397_p2 & or_ln603_fu_428_p2);

assign and_ln603_4_fu_440_p2 = (and_ln603_3_fu_434_p2 & and_ln403_fu_413_p2);

assign and_ln603_fu_606_p2 = (xor_ln581_fu_601_p2 & icmp_ln603_reg_868_pp0_iter9_reg);

assign and_ln621_fu_498_p2 = (xor_ln621_2_fu_478_p2 & lD_fu_494_p1);

assign and_ln631_fu_624_p2 = (xor_ln631_fu_619_p2 & icmp_ln631_reg_935);

assign and_ln639_fu_647_p2 = (xor_ln621_2_reg_916 & icmp_ln631_reg_935);
...
assign ashr_ln586_fu_324_p2 = $signed(p_Result_12_fu_313_p1) >>> zext_ln586_fu_320_p1;

assign ashr_ln623_fu_488_p2 = $signed(p_Result_12_fu_313_p1) >>> zext_ln623_fu_484_p1;

assign deleted_zeros_fu_708_p3 = ((and_ln603_4_reg_906_pp0_iter10_reg[0:0] === 1'b1) ? select_ln639_reg_969 : select_ln639_2_reg_974);
...
assign icmp_ln585_fu_279_p2 = ((F2_4_fu_261_p3 < 12'd54) ? 1'b1 : 1'b0);

assign icmp_ln591_fu_341_p2 = (($signed(F2_reg_830) > $signed(12'd54)) ? 1'b1 : 1'b0);

assign icmp_ln603_fu_295_p2 = ((tmp_56_fu_285_p4 == 9'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln641_fu_656_p2 = ((Range2_V_2_reg_946 == 54'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln837_fu_301_p2 = ((tmp_V_4_reg_812 != 52'd0) ? 1'b1 : 1'b0);

assign j_fu_196_p2 = (j_0_reg_164 + 11'd1);

assign lD_fu_494_p1 = ashr_ln623_fu_488_p2[0:0];

assign or_ln571_2_fu_759_p2 = (icmp_ln571_reg_824_pp0_iter10_reg | and_ln428_fu_704_p2);
...
assign or_ln639_fu_552_p2 = (xor_ln639_2_fu_546_p2 | tmp_59_fu_470_p3);

assign or_ln645_fu_672_p2 = (xor_ln621_2_reg_916 | Range1_all_zeros_2_reg_952);

assign or_ln658_fu_718_p2 = (xor_ln621_fu_713_p2 | deleted_zeros_fu_708_p3);

assign p_Result_12_fu_313_p1 = tmp_1_i_fu_306_p3;

assign p_Result_13_fu_371_p3 = p_Val2_18_fu_334_p3[32'd7];

assign p_Result_s_fu_355_p3 = p_Result_12_fu_313_p1[zext_ln591_fu_351_p1];

assign p_Val2_18_fu_334_p3 = ((icmp_ln585_reg_863[0:0] === 1'b1) ? trunc_ln586_fu_330_p1 : 8'd0);

assign p_Val2_19_fu_383_p2 = (p_Val2_18_fu_334_p3 + zext_ln415_fu_379_p1);

assign p_Val2_20_fu_611_p3 = ((and_ln603_fu_606_p2[0:0] === 1'b1) ? shl_ln604_fu_567_p2 : select_ln403_2_fu_594_p3);
...
assign select_ln340_fu_724_p3 = ((or_ln658_fu_718_p2[0:0] === 1'b1) ? p_Val2_20_reg_963 : 8'd255);

assign select_ln403_2_fu_594_p3 = ((and_ln403_2_fu_589_p2[0:0] === 1'b1) ? p_Val2_19_reg_885 : select_ln403_fu_578_p3);

assign select_ln403_fu_578_p3 = ((and_ln403_reg_896[0:0] === 1'b1) ? p_Val2_19_reg_885 : select_ln582_fu_572_p3);

assign select_ln571_fu_752_p3 = ((or_ln571_fu_746_p2[0:0] === 1'b1) ? 8'd0 : p_Val2_20_reg_963);
...
assign select_ln639_2_fu_696_p3 = ((and_ln639_fu_647_p2[0:0] === 1'b1) ? and_ln641_fu_666_p2 : select_ln642_2_fu_689_p3);

assign select_ln639_fu_681_p3 = ((and_ln639_fu_647_p2[0:0] === 1'b1) ? Range1_all_ones_fu_651_p2 : select_ln642_fu_676_p3);

assign select_ln642_2_fu_689_p3 = ((and_ln642_reg_957[0:0] === 1'b1) ? Range1_all_zeros_fu_661_p2 : or_ln645_fu_672_p2);

assign select_ln642_fu_676_p3 = ((and_ln642_reg_957[0:0] === 1'b1) ? Range1_all_ones_2_reg_923 : xor_ln621_2_reg_916);

assign sext_ln581_fu_317_p1 = F2_4_reg_844;
...
assign tmp_1_i_fu_306_p3 = {{1'd1}, {tmp_V_4_reg_812}};

assign tmp_56_fu_285_p4 = {{F2_4_fu_261_p3[11:3]}};

assign tmp_58_fu_389_p3 = p_Val2_19_fu_383_p2[32'd7];

assign tmp_59_fu_470_p3 = pos1_fu_446_p2[32'd11];

assign tmp_V_4_fu_223_p1 = p_Val2_s_fu_206_p1[51:0];

assign tmp_V_fu_213_p4 = {{p_Val2_s_fu_206_p1[62:52]}};

assign trunc_ln368_fu_209_p1 = p_Val2_s_fu_206_p1[62:0];

assign trunc_ln581_fu_564_p1 = F2_4_reg_844_pp0_iter9_reg[7:0];

assign trunc_ln583_fu_275_p1 = p_Val2_s_fu_206_p1[7:0];

assign trunc_ln586_fu_330_p1 = ashr_ln586_fu_324_p2[7:0];

assign xor_ln403_fu_584_p2 = (p_Result_13_reg_880 ^ 1'd1);

assign xor_ln416_fu_397_p2 = (tmp_58_fu_389_p3 ^ 1'd1);

assign xor_ln428_fu_735_p2 = (1'd1 ^ and_ln428_2_fu_731_p2);

assign xor_ln571_fu_764_p2 = (or_ln571_2_fu_759_p2 ^ 1'd1);
...
assign xor_ln621_2_fu_478_p2 = (tmp_59_fu_470_p3 ^ 1'd1);

assign xor_ln621_fu_713_p2 = (icmp_ln621_reg_911_pp0_iter10_reg ^ 1'd1);

assign xor_ln631_fu_619_p2 = (tmp_60_reg_930 ^ 1'd1);

assign xor_ln639_2_fu_546_p2 = (icmp_ln631_fu_518_p2 ^ 1'd1);
